...
for hemi in cfg.hemisphere:
    ...
    interaction_by_hemi.append([p_corrected])

# tlbx.add_pacs_to_report(df,report,'gavg')
# tlbx.add_pacs_comparison_to_report(df,report,'gavg',analysis_type = 'within_group',extra_masks=interaction_by_hemi)
# tlbx.add_pacs_comparison_to_report(df,report,'gavg',analysis_type = 'between_group',extra_masks=interaction_by_hemi)
