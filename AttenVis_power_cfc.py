    ...
    if not os.path.exists(participant_data_savename) or cfg.overwrite_data:
        ...
        for condition in cfg.brain_selected_conditions:
            ...
            for hemi in cfg.hemisphere:
                ...
                stc_label = stc.in_label(annot_label)
                #get pac
...
tlbx.add_gavg_power_over_time_to_report(df,report,'gavg','Diagnosis',(8,12),ci=False)
tlbx.add_gavg_power_over_time_to_report(df,report,'gavg','Condition',(8,12),ci=False)
